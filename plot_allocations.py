...
ax.plot(range(0, 9), ttts_allocations.iloc[0], label='txts 250', color='pink')
# ax.plot(range(0, 9), ttts_allocations.iloc[1], label='txts 500')
# ax.plot(range(0, 9), ttts_allocations.iloc[2], label='txts 750')
ax.plot(range(0, 9), ttts_allocations.iloc[3], label='txts 1000', color='orange')
...
ax.plot(range(0, 9), ttts_allocations.iloc[7], label='txts 2000', color='red')
ax.plot(range(0, 9), ttts_allocations.iloc[11], label='txts 3000', color='purple')
ax.plot(range(0, 9), np.ones(9) / 9, label='uniform', color='green')
...
ax.plot(range(0, 9), ts_allocations.iloc[7], label='ts 2000', color='brown')
ax.plot(range(0, 9), optimal_allocation, label='fixed constrained optimal', color='black')
plt.legend()
plt.show()
